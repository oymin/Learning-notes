...
public class HlsVideoUtil extends VideoUtil {
    ...
    public String generateM3u8() {
        ...
        /**
         * ffmpeg 生成 m3u8 语法
         * ffmpeg.exe -i lucene.mp4 -hls_time 10 -hls_list_size 0 -hls_segment_filename ./hls/lucene_%05d.ts ./hls/lucene.m3u8
         */
        ...
        String absolute_path = m3u8folder_path + "absolute_" + m3u8_name;
        //通过查看视频时长判断是否成功
    ...
    public List<String> get_ts_list() {
        ...
        try {
            ...
            //bw = new BufferedWriter(new FileWriter(absolute_path));
            while ((str = br.readLine()) != null) {
                //StringBuffer stringBuffer = new StringBuffer();
                bottomline = str;
                if (bottomline.endsWith(".ts")) {
                    tsList.add(bottomline);
                    //stringBuffer.append(m3u8folder_path);
                }
                stringBuffer.append(bottomline);
